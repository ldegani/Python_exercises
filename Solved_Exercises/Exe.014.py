...
if peso > 50:
    print('O peso do seu peixe é de %dkgs, tendo um excesso de %dkgs, você deve pagar uma multa de R$%d.' %(peso, excesso, multa))
else:
    print('O peso do seu peixe é de %dkgs e está dentro do limite, não precisa pagar multa.' %(peso))
